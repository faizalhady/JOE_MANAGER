...
-- lists = number of clusters. Rule of thumb: sqrt(total_rows).
-- Start with 100 lists, rebuild when you have more data.
-- NOTE: This index requires data to exist first. If table is empty,
--       create it AFTER your first batch ingestion.
